...
export function FeatureSection() {
  const storyParagraphs = [
    ...
    "Aro had stolen a rabbit Sera had been tracking for hours. As he turned to leave, proud of his cleverness, he found her standing there—fur bristled, eyes blazing.",
    "“That was mine,” she snapped.",
    "Aro smirked. “Finders keepers.”",
    "“Then I’ll just have to take it back.”",
    "Before he could react, she pounced—not gracefully, not perfectly—but with determination. They tumbled through the grass, a blur of orange and laughter and frustration.",
